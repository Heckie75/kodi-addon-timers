...
class TestSchedulerActions_2_3(unittest.TestCase):
    ...
    def test_tc_2_3_1(self):
        ...
        self.assertEqual(len(schedulderaction._endingTimers), 0)
        self.assertEqual(schedulderaction._fader, None)
        self.assertEqual(schedulderaction._timerToPlayAV.timer.id, timers[1].id)
        self.assertEqual(schedulderaction._timerToStopAV, None)
        self.assertEqual(schedulderaction._timerWithSystemAction, None)
        ...
        self.assertEqual(schedulderaction._fader, None)
        self.assertEqual(schedulderaction._timerToPlayAV, None)
        self.assertEqual(schedulderaction._timerToStopAV.timer.id, timers[1].id)
        self.assertEqual(schedulderaction._timerWithSystemAction, None)
    ...
    def test_tc_2_3_2(self):
        ...
        self.assertEqual(len(schedulderaction._endingTimers), 0)
        self.assertEqual(schedulderaction._fader, None)
        self.assertEqual(schedulderaction._timerToPlayAV.timer.id, timers[0].id)
        self.assertEqual(schedulderaction._timerToStopAV, None)
        self.assertEqual(schedulderaction._timerWithSystemAction, None)
