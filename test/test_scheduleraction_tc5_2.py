...
class TestSchedulerActions_5_2(unittest.TestCase):
    ...
    def test_tc_5_1_3(self):
        ...
        self.assertEqual(len(schedulderaction._endingTimers), 0)
        self.assertEqual(
            schedulderaction._timerToPlaySlideshow.timer.id, timers[0].id)
        self.assertEqual(schedulderaction._fader.timer.label, timers[1].label)
        self.assertEqual(
            schedulderaction._timerToPlayAV.timer.id, timers[1].id)
        self.assertEqual(schedulderaction._timerToStopSlideshow, None)
        self.assertEqual(schedulderaction._timerWithSystemAction, None)
        ...
        self.assertEqual(len(schedulderaction._endingTimers), 0)
        self.assertEqual(schedulderaction._timerToPlaySlideshow, None)
        self.assertEqual(schedulderaction._fader.timer.label, timers[1].label)
        self.assertEqual(schedulderaction._timerToPlayAV, None)
        self.assertEqual(schedulderaction._timerToStopSlideshow, None)
        self.assertEqual(schedulderaction._timerWithSystemAction, None)
        ...
        self.assertEqual(schedulderaction._timerToPlayAV, None)
        self.assertEqual(
            schedulderaction._timerToStopSlideshow.timer.id, timers[0].id)
        self.assertEqual(
    ...
    def test_tc_5_1_4(self):
        ...
        self.assertEqual(schedulderaction._fader, None)
        self.assertEqual(
            schedulderaction._runningTimers[0].timer.id, timers[0].id)
        self.assertEqual(schedulderaction._timerToStopSlideshow, None)
        self.assertEqual(schedulderaction._timerWithSystemAction, None)
